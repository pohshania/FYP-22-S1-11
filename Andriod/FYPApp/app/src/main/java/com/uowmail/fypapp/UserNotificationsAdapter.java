...
public class UserNotificationsAdapter extends FirestoreRecyclerAdapter<UserNotificationModel, UserNotificationsAdapter.UserNotificationViewHolder> {

    private OnListItemClick onListItemClick;

    public UserNotificationsAdapter(@NonNull FirestoreRecyclerOptions<UserNotificationModel> options, OnListItemClick onListItemClick) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull UserNotificationViewHolder holder, int position, @NonNull UserNotificationModel model) {
    ...
    public void onDataChanged() {
        super.onDataChanged();
        UserNotificationFragment.disableProgressBar();
    }

    @Override
    public void updateOptions(@NonNull FirestoreRecyclerOptions<UserNotificationModel> options) {
    ...
    public interface OnListItemClick{
        void onItemClick(UserNotificationModel snapshot, int position);
    }
